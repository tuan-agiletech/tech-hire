...
export default function CustomFieldsEmptyState({ onCreate }: CustomFieldsEmptyStateProps) {
  return (
    <div className="text-center">
      ...
      <h3 className="mt-2 text-sm font-semibold text-gray-900">No Custom Fields</h3>
      <p className="mt-1 text-sm text-gray-500">
        Define custom fields and personalize candidate profiles
      </p>
      <div className="mt-6">
        <button
          type="button"
